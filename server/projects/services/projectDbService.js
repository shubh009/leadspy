...
function formatProjectForClient(row) {
  ...
  return {
    ...
    clientProfileUrl: row.client_profile_url,
    clientContactMethod: row.client_contact_method,
    clientLocation: row.client_location || 'Remote',
    budget: row.budget || 'Negotiable',
    budgetMin: row.budget_min,
    budgetMax: row.budget_max,
    projectType: row.project_type || 'Contract',
