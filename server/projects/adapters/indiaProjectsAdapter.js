    ...
    return [
      {
        ...
        rawContent: 'Delhi NCR Logistics Startup | We need an experienced web development agency or freelance developer team to build our dispatch and fleet tracking dashboard. Tech Stack: React, Node.js, Express, PostgreSQL, Google Maps API integration. Budget: ₹1,50,000 - ₹2,50,000 fixed milestone. Timeline: 4-6 weeks. Location: Delhi NCR / Remote India.',
      ...
      },
      {
        ...
        rawContent: 'HealthPlus Clinics (Bangalore) | Looking for a mobile app development agency or senior Flutter developer to develop our Android & iOS consultation and appointment booking app with Razorpay payment gateway and video call integration. Budget: ₹2,00,000 - ₹3,50,000. Location: Bangalore / Remote India.',
      ...
      },
      {
        ...
        rawContent: 'Fashion Brand based in Mumbai | Seeking Shopify / Next.js frontend expert to revamp our high-traffic e-commerce store with custom product customizer and speed optimization. Budget: ₹75,000 - ₹1,20,000 fixed project. Location: Mumbai / Remote India.',
